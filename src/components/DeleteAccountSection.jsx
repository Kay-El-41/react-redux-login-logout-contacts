...
const DeleteAccountSection = ({ showSection }) => {
...
// This is intended to use for both admin and contacts if necessary

// This is need to edit whole, I copied from changePasswordSection